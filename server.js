...
db.serialize(() => {
    ...
    db.get("SELECT COUNT(*) as count FROM appointments", [], (err, row) => {
        ...
        const seed = [
            ...
            [d0, '10:00', 'Swedish Massage', 60, 'Георги Иванов', '0887123456', 'georgi@mail.bg', 'confirmed', prefix + '-1001'],
            [d0, '11:00', 'Пълен Пакет', 35, 'Димитър Петров', '0898765432', null, 'confirmed', prefix + '-1002'],
            [d0, '15:00', 'Manicure + Pedicure', 65, 'Николай Стоянов', '0879111222', null, 'pending', prefix + '-1003'],
            [d0, '16:30', 'Swedish Massage', 60, 'Александър Тодоров', '0888333444', 'alex.t@gmail.com', 'pending', prefix + '-1004'],
            [d0, '17:30', 'Classic Facial', 70, 'Мария Колева', '0897555666', null, 'pending', prefix + '-1005'],
            // Утре
            [d1, '10:30', 'Пълен Пакет', 35, 'Стефан Георгиев', '0887222333', 'stefan.g@abv.bg', 'confirmed', prefix + '-1006'],
            [d1, '12:00', 'Swedish Massage', 60, 'Красимир Димитров', '0878444555', null, 'pending', prefix + '-1007'],
            [d1, '15:30', 'Manicure + Pedicure', 65, 'Иван Маринов', '0889666777', null, 'confirmed', prefix + '-1008'],
            // Вдругиден
            [d2, '11:00', 'Пълен Пакет', 35, 'Петър Николов', '0897888999', 'peter.n@mail.bg', 'pending', prefix + '-1009'],
            // Минали дни (за chart-а)
            [dm1, '10:00', 'Swedish Massage', 60, 'Тодор Василев', '0887111000', null, 'confirmed', prefix + '-0901'],
            [dm1, '11:30', 'Пълен Пакет', 35, 'Борис Христов', '0898222111', null, 'confirmed', prefix + '-0902'],
            [dm1, '16:00', 'Manicure + Pedicure', 65, 'Калоян Атанасов', '0879333222', null, 'confirmed', prefix + '-0903'],
            [dm2, '10:30', 'Swedish Massage', 60, 'Васил Добрев', '0888444333', null, 'confirmed', prefix + '-0904'],
            [dm2, '15:00', 'Пълен Пакет', 35, 'Емил Стоев', '0897555444', null, 'confirmed', prefix + '-0905'],
            [dm3, '11:00', 'Classic Facial', 70, 'Анна Попова', '0887666555', null, 'confirmed', prefix + '-0906'],
            [dm3, '12:00', 'Swedish Massage', 60, 'Мартин Ковачев', '0898777666', null, 'confirmed', prefix + '-0907'],
            [dm3, '16:30', 'Manicure + Pedicure', 65, 'Христо Йорданов', '0879888777', null, 'rejected', prefix + '-0908'],
            [dm4, '10:00', 'Пълен Пакет', 35, 'Даниел Кръстев', '0888999888', null, 'confirmed', prefix + '-0909'],
            [dm4, '15:30', 'Swedish Massage', 60, 'Пламен Костов', '0897000999', null, 'confirmed', prefix + '-0910'],
            [dm5, '11:30', 'Swedish Massage', 60, 'Радослав Генчев', '0887111222', null, 'confirmed', prefix + '-0911'],
